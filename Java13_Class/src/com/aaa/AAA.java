...
public class AAA {
	...
	// default constructor(기본 생성자) : 자바가 자동으로 만들어줌
	public AAA() {
	 ...
	 * 4. overload 할 수 있다.
	 * class Test {
	 * 		public Test() {}	// default constructor(기본 생성자) : 파라미터가 없는 생성자
	 * 		public Test(int a) {}
	 * 		public Test(int a, int b) {}
	 * }
	 * 
	 * 5. 생성자를 명시하지 않으면 자바가 기본 생성자를 제공하여 필드를 초기화하고, 명시된 생성자를 선언하게 되면 명시 생성자만 호출되고 기본 생성자는 제공되지 않는다.
	 * class AA {
	 * 						// new AA();
	 * }
	 * 
